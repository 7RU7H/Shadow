...
Inspired and refactored from old versions of go netcat clones on giuthub [go-netcat](https://github.com/vfedoroff/go-netcat/blob/master/main.go), [go-nc](https://github.com/opencoff/go-nc/blob/master/gonc.go). Wanted to add more functionality like socat encryption and easy ncat file transfers, but in golang where the it can be ran on anything. 

Early Days, having way too much fun with Copilot.

# Hopes and dreams on feature creep back of my skull.

Payload injection
Process migration aware
